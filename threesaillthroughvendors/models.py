...
class TTVIllSalesDetails(models.Model):
...
class TTVIllNocDetails(models.Model):
    ROUTING_CHOICES = (
        ('1', 'done'),
        ('2', 'pending'),
    )
...
class TTVIllFieldEngineerDetails(models.Model):
    linkstatus = (
        ('1', 'up'),
        ('2', 'down'),
    )
    ...
    class Meta:
        verbose_name_plural = '4. Field Engineer Details'


class TTVIllBillingDetails(models.Model):
    paymentstatus = (
        ('1', 'Done'),
        ('2', 'Pending'),
    )
    ...
    class Meta:
        verbose_name_plural = '5. Billing Details'


class TTVIllDoneConnectionsDetails(models.Model):
    linkstatus = (
        (True, 'Active'),
        (False, 'Deactive'),
    )
    ...
    sale_code = models.ForeignKey(TTVIllSalesDetails, models.SET_NULL, verbose_name='sales details', blank=True,
                                  null=True)
    noc_code = models.ForeignKey(TTVIllNocDetails, models.SET_NULL, verbose_name='NOC details', blank=True,
                                 null=True)
    fe_code = models.ForeignKey(TTVIllFieldEngineerDetails, models.SET_NULL, verbose_name='FE details', blank=True,
                                null=True)
    billing_code = models.ForeignKey(TTVIllBillingDetails, models.SET_NULL, verbose_name='billing details',
                                     blank=True, null=True)
    ...
    class Meta:
        verbose_name_plural = '1. TTV ILL Done Connections'