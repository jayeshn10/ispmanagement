...
from vendorsillthroughthreesa.models import VTTIllSalesDetails, VTTIllFiberTeam, \
    VTTIllNocDetails, VTTIllFieldEngineerDetails, VTTIllBillingDetails


class AddIllConForm(forms.ModelForm):
    conn_type_CHOICES = (
        ('3', "Vendor Through Threesa"),
    )
...
class AddFieldEnggDetailsForm(forms.ModelForm):
    class Meta:
        model = VTTIllFieldEngineerDetails
